...
function celsius() {
  ...
  "cels" us added to the value of 32 and this sum is the value of fahr.  */
  ...
  the string "degrees Celsisus equals" which was concatenated to the value of the variable fahr (the toFixed() method
was applied to the variable fahrs so that only 2 decimal places are kept).
